              ...
              >
                ...
                >
                  ...
                  <div class="group relative ml-auto">
                    ...
                    <span class="absolute top-0 z-50 ml-4 mt-10 hidden w-screen max-w-lg rounded-md border bg-white p-6 text-gray-900 shadow-lg group-hover:block">
                      <article>
                        <header>
                          <div>
                            <span class="rounded-sm bg-red-600 px-3 py-1 text-xs uppercase leading-none text-white">
                              Open
                            </span>
                        ...
                        <footer class="mt-4">
                          ...
                          <div class="mt-3 flex">
                            ...
                            <p class="ml-auto text-sm text-gray-700">
                              Yesterday 10:33
                            </p>
                          </div>
                          <p class="mt-2">
                  ...
                  <div class="group relative ml-auto">
                    ...
                    <span class="absolute top-0 z-50 ml-4 mt-10 hidden w-screen max-w-lg rounded-md border bg-white p-6 text-gray-900 shadow-lg group-hover:block">
                      <article>
                        <header>
                          <div>
                            <span class="rounded-sm bg-yellow-400 px-3 py-1 text-xs uppercase leading-none text-black">
                              New
                            </span>
                            <span class="ml-2 text-gray-700">
                              Incident #12534
                      ...
                      <article>
                        ...
                        <footer class="mt-4">
                          ...
                          <div class="mt-3 flex">
                            ...
                            <p
                              aria-label="time"
                              class="ml-auto text-sm text-gray-700"
                            >
                              Today 06:34
                            </p>
                          </div>
